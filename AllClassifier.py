import pandas as pd
df = pd.read_csv('/home/hasanmdmehadi/ACADEMIC_PROJECTS/ML Lab /Sentimental Analysis/sentiment.csv')
...
print(classifier.score(data_test, targets_test))
...
print("neural network starts here")
#neural network
